...
public class DicasFragment extends Fragment {
    ...
    public void setInfo(View v) {
        ...
        listItem.put("Saúde", Arrays.asList(getString(R.string.saude_1), getString(R.string.saude_2), getString(R.string.saude_3), getString(R.string.saude_4), getString(R.string.saude_5), getString(R.string.saude_6), getString(R.string.saude_7), getString(R.string.saude_8), getString(R.string.saude_9)));
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                switch (selectedItem) {
                    case "Como cortar as unhas do seu cachorro":
                        ...
                        DicaFragment DicasSaude1Fragment = new DicaFragment();
                        FragmentManager fragmentManager = getFragmentManager();
                        fragmentManager.beginTransaction()
                                .replace(R.id.content_frame, DicasSaude1Fragment, MainActivity.FRAGMENT_DICA_TAG)
                                .addToBackStack(null)
                                .commit();
                        break;
                }
